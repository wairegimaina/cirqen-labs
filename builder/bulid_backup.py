...
# Fixed for Linux (Ubuntu, Tails, etc.) - QtWebEngine GPU sandbox fix
# ============================================================
cd "$(dirname "$0")"

echo "🚀 Starting Cirqen Desktop Application..."

# QtWebEngine / Chromium sandbox fix
# Required on Linux when the Chromium GPU subprocess fails to spawn.
# Common on Ubuntu, Tails, and other Linux distros with QtWebEngine apps.
