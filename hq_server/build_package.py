...
def _genkeys():
    ...
    print("   Render -> cirqen-hq-update-server -> Environment -> Add.")
    print("   Whoever holds this can sign packages that every desktop executes,")
    print("   so treat it like a production database password: never commit it,")
    print("   never paste it into a chat, ticket or log.")
    print()
    print("   " + private_b64)
    print()
