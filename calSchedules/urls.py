...
urlpatterns = [
    ...
    path('push/<uuid:pk>/', views.push_calibration_schedule, name='push_calibration_schedule'),
    path('complete/<uuid:pk>/', views.mark_calibration_completed, name='mark_calibration_completed'),
    path('edit/<uuid:pk>/', views.edit_calibration_schedule, name='edit_calibration_schedule'),
    path('delete/<uuid:pk>/', views.delete_calibration_schedule, name='delete_calibration_schedule'),
